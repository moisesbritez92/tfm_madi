...
MODEL_DIR = THIS_DIR / "models" / "V1"
ARTIFACT_DIR = THIS_DIR / "artifacts" / "v1_inference"
PREFERRED_CHECKPOINT = "epoch=0150-test_mean_score=0.668.ckpt"
...
def plot_checkpoint_comparison(rows: list[dict[str, Any]], figsize: tuple[int, int] = (9, 4)):
    return _plot_checkpoint_comparison(
        rows,
        figsize=figsize,
        title="V1 checkpoints on the same seed",
    )
