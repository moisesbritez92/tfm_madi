...
MODEL_DIR = THIS_DIR / "models" / "V3"
ARTIFACT_DIR = THIS_DIR / "artifacts" / "v3_inference"
PREFERRED_CHECKPOINT = "epoch=0100-test_mean_score=0.622.ckpt"
...
def plot_checkpoint_comparison(rows: list[dict[str, Any]], figsize: tuple[int, int] = (9, 4)):
    return _plot_checkpoint_comparison(
        rows,
        figsize=figsize,
        title="V3 checkpoints across test seeds",
    )
