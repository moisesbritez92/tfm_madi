...
MODEL_DIR = THIS_DIR / "models" / "V4"
ARTIFACT_DIR = THIS_DIR / "artifacts" / "v4_inference"
PREFERRED_CHECKPOINT = "epoch=0100-test_mean_score=0.535.ckpt"
...
def plot_checkpoint_comparison(rows: list[dict[str, Any]], figsize: tuple[int, int] = (9, 4)):
    return _plot_checkpoint_comparison(
        rows,
        figsize=figsize,
        title="V4 checkpoints across test seeds",
    )
