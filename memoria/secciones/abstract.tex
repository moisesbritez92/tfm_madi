...
\num{200} episodes from a disjoint seed block, under a protocol fixed in advance, together
with the compute time consumed.
...
By contrast, only one difference among the pretrained variants exceeds the family-wise
\SI{5}{\percent} threshold. Each V0 epoch takes \SI{1.6}{\minute}, compared with
