...
consecutivas. La variable de resultado secundaria es la tasa de \'exito, es decir la fracci\'on de
condiciones cuya puntuaci\'on alcanza el umbral.
...
las variables de resultado y el an\'alisis, se fij\'o por escrito y se registr\'o en el repositorio antes
de ejecutar la evaluaci\'on.
...
La familia de hip\'otesis la forman las diez comparaciones por pares de la variable de resultado principal.
Sus valores $p$ se ajustan mediante el procedimiento secuencial de Holm, que controla el
