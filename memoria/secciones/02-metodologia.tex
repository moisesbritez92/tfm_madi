...
Adem\'as del presupuesto, el tama\~no de lote de V4 se redujo a la mitad porque CLIP
ViT-B/16 no cabe en los ocho gigabytes de memoria gr\'afica con lotes de \num{64} muestras.
Esta desviaci\'on duplica el n\'umero de actualizaciones por \'epoca respecto a las dem\'as
variantes, extremo que se retoma al interpretar los resultados.
...
Al comparar las cinco variantes se realizan diez contrastes por pares. Sus valores $p$ se
ajustan mediante el procedimiento secuencial de Holm, que controla el error familiar sin
suponer independencia entre contrastes. La significaci\'on se determina sobre los valores
ajustados con un umbral de \num{0.05}.
